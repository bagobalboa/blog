...
<form action="signup-handler.php" method="post">
	...
	<div class="form-group">
		...
		<small id="image-help" class="form-text text-muted">L'URL qui pointe vers votre image de profil.</small>
	</div>
	...
	<div class="form-group">
		...
		<input type="password" class="form-control" name="password_conf" id="password_conf" aria-describedby="password_conf-help" placeholder="Confirmation du mot de passe" required minlength="6"></textarea>
